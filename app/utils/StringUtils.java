...
public class StringUtils {
	...
	public static String numerico(String valor, Integer longitud) {
		if (valor != null) {
			valor = valor.trim();
	...
	public static String cortarString(String valor, Integer longitud) {
		if (valor != null) {
			valor = valor.trim();
			if(valor.length() > longitud) {
				valor = valor.substring(0,longitud);
	...
	public static String alfanumerico(String valor, Integer longitud) {
		if (valor != null) {
			valor = valor.trim();
			if(valor.length() > longitud) {
				valor = valor.substring(0,longitud);
	...
	public static String alfanumericoPadStart(String valor, Integer longitud) {
		if (valor != null) {
			valor = valor.trim();
			if(valor.length() > longitud) {
				valor = valor.substring(0,longitud);
		...
		return Strings.padStart(valor, longitud, ' ');
	}
