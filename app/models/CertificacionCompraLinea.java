...
@Entity 
@Table(name = "certificaciones_compras_lineas")
public class CertificacionCompraLinea extends Model{
	
	private static final long serialVersionUID = 1L;
	@Id  														 
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="certificaciones_compras_lineas_id_seq")
	public Long id;
	...
	public static Model.Finder<Long,CertificacionCompraLinea> find = new Finder<Long,CertificacionCompraLinea>(Long.class, CertificacionCompraLinea.class);
	
	public static Pagination<CertificacionCompraLinea> page(Long certificacionId) {    	
    	Pagination<CertificacionCompraLinea> p = new Pagination<CertificacionCompraLinea>();
