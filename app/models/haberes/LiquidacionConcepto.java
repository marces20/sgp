...
public class LiquidacionConcepto extends Model{
	...
	public static final long ADICIONAL_MAYOR_CARGAR_HORARIA = 690;//ADIC. TEMP. POR MAYOR CARGA HORARIA EMERG. COVID-19/DENGUE

	public static final long HORAS_ADMINISTRATIVAS_PASIVAS_DIA_FESTIVO = 818;//HORAS ADMINISTRATIVAS PASIVAS DIA FESTIVO

	public static final long HORAS_ADMINISTRATIVAS_FESTIVAS = 669;//HORAS ADMINISTRATIVAS FESTIVAS

	public static final long  VALOR_NO_HABIL_ENFERMERIA_EMERGCOVID19 = 689;//VALOR NO HABIL ENFERMERIA EMERG. COVID-19/DENGUE

	public static final long  NOCTURNIDAD_EMERGUER_COVID = 730;//NOCTURNIDAD EMERG. COVID-19/DENGUE
