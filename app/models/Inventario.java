...
public class Inventario extends Model {
	...
	public static Pagination<Inventario> page(String prefijo, String numero, String remito, String proveedor, String producto_id) {    	
    	Pagination<Inventario> p = new Pagination<Inventario>();
    	p.setOrderDefault("DESC");
    	p.setSortByDefault("numero");
    	
    	ExpressionList<Inventario> e = find.where();
