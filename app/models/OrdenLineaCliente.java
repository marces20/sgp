...
public class OrdenLineaCliente extends Model{
	...
	@ManyToOne
	@JoinColumn(name="ida_institucion_externa_id", referencedColumnName="id", insertable=false, updatable=false)
	public InstitucionExterna idaInstitucionExterna;
	public Long ida_institucion_externa_id;

	@ManyToOne
	@JoinColumn(name="vuelta_institucion_externa_id", referencedColumnName="id", insertable=false, updatable=false)
	public InstitucionExterna vueltaInstitucionExterna;
	public Long vuelta_institucion_externa_id;
