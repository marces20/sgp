...
@Entity
@Table(name = "recupero_notas_creditos")
public class RecuperoNotaCredito extends Model{

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="recupero_notas_creditos_id_seq")
	public Long id;
	...
	public static Model.Finder<Long,RecuperoNotaCredito> find = new Finder<Long,RecuperoNotaCredito>(Long.class, RecuperoNotaCredito.class);

	public static Pagination<RecuperoNotaCredito> page(Long recuperoFacturaId,
			String numero,
    	...
    	Pagination<RecuperoNotaCredito> p = new Pagination<RecuperoNotaCredito>();
    	p.setOrderDefault("DESC");
    	p.setSortByDefault("fecha");

    	ExpressionList<RecuperoNotaCredito> e = find.fetch("recupero_factura")
    											.fetch("puntoVenta")
    											.fetch("planilla")
