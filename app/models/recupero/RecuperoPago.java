...
private static final long serialVersionUID = 1L;
	...
	@ManyToOne
	@JoinColumn(name="recupero_nota_credito_id", referencedColumnName="id", insertable=false, updatable=false)
	public RecuperoNotaCredito recuperoNotaCredito;
	public Integer recupero_nota_credito_id;

	@ManyToOne
	@JoinColumn(name="recupero_nota_debito_id", referencedColumnName="id", insertable=false, updatable=false)
	public RecuperoNotaDebito recuperoNotaDebito;
	public Integer recupero_nota_debito_id;
