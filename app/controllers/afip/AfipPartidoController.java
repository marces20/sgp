...
import utils.afip.wsfe.wsdl.ArrayOfCbteAsoc;
import utils.afip.wsfe.wsdl.ArrayOfFECAEDetRequest;
import utils.afip.wsfe.wsdl.CbteAsoc;
import utils.afip.wsfe.wsdl.Err;
import utils.afip.wsfe.wsdl.FEAuthRequest;
import utils.afip.wsfe.wsdl.FECAECabRequest;
import utils.afip.wsfe.wsdl.FECAEDetRequest;
import utils.afip.wsfe.wsdl.FECAEDetResponse;
import utils.afip.wsfe.wsdl.FECAERequest;
import utils.afip.wsfe.wsdl.FECAESolicitar;
import utils.afip.wsfe.wsdl.FECAESolicitarResponse;
import utils.afip.wsfe.wsdl.FECompUltimoAutorizado;
import utils.afip.wsfe.wsdl.FECompUltimoAutorizadoResponse;
import utils.afip.wsfe.wsdl.Obs;

public class AfipPartidoController {
	...
	public static String login() throws IOException, DatatypeConfigurationException, EmailException {
		...
		// openssl pkcs12 -export -inkey privada -in partido_21b5797e6dce4e18.crt -name parquesalud -out PARQUESALUD_53794c62e26a1a54.p12
		...
		InputStream in = Play.application().resourceAsStream("resources/partido_21b5797e6dce4e18.p12");

		String dirTemp = System.getProperty("java.io.tmpdir");
		File archivo = null;
		if (play.Play.isProd()) {
			dirTemp ="/home/administrador/";
			archivo = new File(dirTemp+"/partido_21b5797e6dce4e18.p12");
		...
		byte [] LoginTicketRequest_xml_cms = create_cms(archivo.getAbsolutePath(), "partido", "partido", dstDN, "wsfe", new Long(28800000));
	...
	public FEAuthRequest getAuth() throws IOException, DatatypeConfigurationException, EmailException {
		...
		auth.setCuit(Long.parseLong("30709807133"));
	...
	public ObjectNode setComprobante(Long  id,int cbteTipo) {
		...
		try {
			...
			RecuperoPartido rf = RecuperoPartido.find.where().eq("id", id).isNull("cae").findUnique();


			Logger.debug("==============CAAAAAAAAAEEEEEEEEEEEEE222=============000000 "+rf.numero );


			if(cbteTipo == TipoComprobante.RECIBO_C) {
				System.out.println("==========NOTAAA FACTURAAA==================");

				importe = rf.getMonto().doubleValue();
			...
			if(rf != null) {
				...
				if(doc != null) {
			        ...
			        fECAECabRequest.setCbteTipo(TipoComprobante.RECIBO_C);
