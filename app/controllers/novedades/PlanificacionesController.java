...
public class PlanificacionesController extends Controller {
	...
	public static Result crearNovedadesMaternoResidentes(Long id) {
		Planificacion p = Planificacion.find.byId(id);
		...
		try {
			...
			for(SqlRow sx :novedades) {
				...
				n.liquidacion_concepto_id=LiquidacionConcepto.COMPENSADOR_TAREAS;
		 ...
		 try {
			 ...
			 if((rf.nota_servicio != null && !rf.nota_servicio.isEmpty()) || (rf.nota_rrhh != null && !rf.nota_rrhh.isEmpty()) || (rf.nota_liquidaciones != null && !rf.nota_liquidaciones.isEmpty())) {
				 ...
				 notas += "<div class=\"border_div\" style=\"height:900px;padding:10px;border-top:none; border-bottom:2px solid; font-size:20px;text-align: justify;\">\n" +
					 		"     <p>NOTAAAAAAAAAAAAAAAAAAAASSS.</p>\n" +
					 		"</div>";
				 footerPage = ReportePdf.getFooterPage(pag, qpag);
				 String hoja = "<div class=\"border_div\" style=\"height:900px; padding:10px;border-top:none; border-bottom:2px solid #000000;text-align: justify;\">\n"
					 		+notas+"</div>";
