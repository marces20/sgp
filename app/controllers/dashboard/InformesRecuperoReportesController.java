...
public class InformesRecuperoReportesController extends Controller {
	...
	public static Result deudasPorTipoDeCliente(Long idTipoCliente) {
		...
		try {
			...
			Sheet hoja = getDeudasPorTipoDeClienteSheet(libro,idTipoCliente);
	...
	public static Sheet getDeudasPorTipoDeClienteSheet(Workbook libro,Long idTipoCliente){
