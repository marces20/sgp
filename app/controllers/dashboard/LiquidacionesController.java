...
public class LiquidacionesController extends Controller {
	...
	public static Result liquidacionesPorAgrupadoOrganigrama() {
		...
		if(!RequestVar.get("periodo_id").isEmpty()){
			...
			List<SqlRow> rowParque = PuestoLaboral.getTotalesPorAgrupadosOrganigramaPeriodo(idPeriodo);
			
			 
																		  
			
			return ok(liquidacionesPorAgrupadoOrganigrama.render(formBuscador,rowParque));
		}
		
		return ok(liquidacionesPorAgrupadoOrganigrama.render(formBuscador,null));
