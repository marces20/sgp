...
public class BalancePresupuestarioReportesController extends Controller {
	...
	public static Result modalReporteBalancePorCuenta() {
		DynamicForm d = form().bindFromRequest();
		return ok(modalReporteBalancePorCuenta.render(null,d));
	}

	public static Result reporteBalancePorCuenta() throws IOException {
		...
		return ok(modalReporteBalancePorCuenta.render(archivo.getPath(),d));
	}
