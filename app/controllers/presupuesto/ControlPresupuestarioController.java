...
public class ControlPresupuestarioController extends Controller {
	...
	public static Result movimientosCargaDeCreditos() {
		...
		String sql = "select sum(monto) as monto,l.id,l.cuenta_analitica_id,ca.nombre as cuenta "+
		...
		List<SqlRow> saldosIniciales = Ebean.createSqlQuery(sql)
		...
		List<SqlRow> movimientos = Ebean.createSqlQuery(sql2)
				.setParameter("idEjercicio",idEjercicio)
				.findList();
