...
public class EjerciciosController extends Controller {
	...
	public static Result get(int id){
		Ejercicio ejercicio = Ejercicio.find.select("id, nombre").where().eq("id", id).findUnique();
	...
	public static Result modalBuscar() {
    	...
    	p.setExpressionList(Ejercicio.find.where().ilike("nombre", "%" + RequestVar.get("nombre") + "%"));
