...
public class OrdenesPagosCircuitosAccionesController extends Controller {
	...
	public static Result modalPasarContabilidad() {
	...
	public static Result pasarContabilidadMasivo() {
		...
		try {
			...
			Integer count2 = ExpedienteMovimiento.pasarOtroServicioMasivoConOps(idsExpedientes,ocx, Organigrama.CONTABILIDAD, "");
