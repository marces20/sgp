...
public final class Authentication extends Controller {
	...
	private static final int SESSION_TIMEOUT = 60 * 60; // 30 minutos en segundos
    ...
    public static Usuario authenticate(final String nick, final String password){
    	...
    	if(usuario != null){
    		...
    		session("timestamp", String.valueOf(System.currentTimeMillis()));
    	}
    ...
    public static boolean isSessionValid() {
        ...
        long lastAccess = Long.parseLong(timestamp);
        long now = System.currentTimeMillis();
        long diff = (now - lastAccess) / 1000; // diferencia en segundos
