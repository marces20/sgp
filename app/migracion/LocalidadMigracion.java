...
public class LocalidadMigracion {
	public boolean migrar(){
		...
		try {
			...
			System.out.println("Empezo a migrar LocalidadMigracion");
			
        	conn = Configuration.get().getConnection();
        	conn2 = Configuracion2.get2().getConnection2();
        	System.out.println("2222222222");
			PreparedStatement stmt = conn.prepareStatement("select " +
					" ru.id,ru.name,ru.state_id"+
					" from res_localidad ru where id = 486");
			...
			while (rs.next()) {
				System.out.print('1');
				 stmt2 = conn2.prepareStatement("INSERT INTO localidades " +
			...
			stmt.close();
			stmt2.close();
			System.out.println("Termino a migrar LocalidadMigracion");
