...
public class EspecialidadesMigrar {
	...
	public boolean migrar(){
		...
		try {
			...
			System.out.println("Empezo a migrar EspecialidadesMigrar");
			...
			PreparedStatement stmt = conn.prepareStatement("select " +
					...
					" ru.create_uid, " +
					" ru.create_date" +
					" from hr_especialidad ru where id = 149");
			...
			while (rs.next()) {
				System.out.print('1');
				 stmt2 = conn2.prepareStatement("INSERT INTO especialidades " +
			...
			stmt.close();
			stmt2.close();
			System.out.println("Termino a migrar EspecialidadesMigrar");
