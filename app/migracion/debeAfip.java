...
public class debeAfip {
	...
	public boolean insertar() throws IOException{
		...
		String csvFile = "/home/marce/working/play-2.2.1/sgp/conf/resources/csv/debeafip.csv";
		String line = "";
		String cvsSplitBy = "@";
		int c = 0;
		int r = 0;
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				while (rs.next()) {
					PreparedStatement stmt2 = conn2.prepareStatement("UPDATE facturas SET debe_afip = true WHERE id = ?");
