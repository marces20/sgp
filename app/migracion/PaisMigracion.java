...
public class PaisMigracion {
	public void migrar(){
		...
		try {
			...
			System.out.println("Empezo a migrar PaisMigracion");
			...
			while (rs.next()) {
				System.out.print('1');
				 stmt2 = conn2.prepareStatement("INSERT INTO pais " +
						" (id,nombre)" +
						" VALUES (?,?)");
			...
			stmt.close();
			stmt2.close();
			System.out.println("Termino a migrar PaisMigracion");
