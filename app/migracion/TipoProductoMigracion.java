...
public class TipoProductoMigracion {
	...
	public void migrar(){
		...
		try {
			...
			System.out.println("Empezo a migrar Tipo Producto");
			...
			while (rs.next()) {
				System.out.print('1');
				 stmt2 = conn2.prepareStatement("INSERT INTO tipo_productos " +
			...
			stmt.close();
			stmt2.close();
			System.out.println("Termino a migrar Tipo Producto");
