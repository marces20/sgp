...
public class PuestoMigracion {
	public void migrar(){
		...
		try {
			...
			System.out.println("Empezo a migrar PuestoMigracion");
			...
			while (rs.next()) {
				System.out.print('1');
				 stmt2 = conn2.prepareStatement("INSERT INTO puestos " +
			...
			stmt.close();
			stmt2.close();
			System.out.println("Termino a migrar PuestoMigracion");
