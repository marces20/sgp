...
public class LineaRecursoMigracion {
public void migrar(){
		...
		try {
			...
			System.out.println("Empezo a migrar LineaRecursoMigracion");
			...
			while (rs.next()) {
				if(rs.getLong(3) != 0){
					System.out.print('1');
					stmt2 = conn2.prepareStatement("INSERT INTO lineas_recursos_presupuestarios " +
			...
			stmt.close();
			stmt2.close();
			System.out.println("Termino a migrar LineaRecursoMigracion");
