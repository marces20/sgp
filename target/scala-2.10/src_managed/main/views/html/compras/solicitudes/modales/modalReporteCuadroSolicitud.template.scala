...
import views.html._
/**/
object modalReporteCuadroSolicitud extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template1[String,play.api.templates.HtmlFormat.Appendable] {
...
"""),_display_(Seq[Any](/*11.2*/if(url)/*11.9*/ {_display_(Seq[Any](format.raw/*11.11*/("""
	<div class="panel panel-default">
		<div class="panel-body">
	    	<i class="glyphicon glyphicon-save"></i> <a href=""""),_display_(Seq[Any](/*14.58*/controllers/*14.69*/.contabilidad.routes.FacturasAccionesController.descargar322(url))),format.raw/*14.134*/("""">Descargar archivo Cuadro Solicitud</a>
		</div>
	</div>
""")))})),format.raw/*17.2*/("""
...
"""),_display_(Seq[Any](/*19.2*/flash()/*19.9*/.clear())))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/compras/solicitudes/modales/modalReporteCuadroSolicitud.scala.html
                    HASH: d1855722d894f665edf78532a15dbedd5e071c6b
                    MATRIX: 824->1|938->21|975->24|1013->54|1052->56|1170->139|1183->144|1218->157|1256->165|1293->168|1333->200|1372->202|1489->284|1502->289|1539->304|1577->312|1615->315|1630->322|1670->324|1826->444|1846->455|1934->520|2024->579|2062->582|2077->589
