...
"""),_display_(Seq[Any](/*5.2*/helper/*5.8*/.form(action = controllers.contabilidad.routes.FacturasAccionesController.pasarBorradorMasivo(), 'id -> "formPasarBorradorFactura")/*5.139*/ {_display_(Seq[Any](format.raw/*5.141*/("""	
...
"""),_display_(Seq[Any](/*14.2*/flash()/*14.9*/.clear())))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/contabilidad/facturas/acciones/modalPasarBorrador.scala.html
                    HASH: 4b8b60680cb61f411a30846b5282a2161ba9c2f3
                    MATRIX: 823->1|952->47|984->71|1058->28|1086->115|1125->120|1138->126|1278->257|1318->259|1358->265|1370->270|1416->295|1637->485|1674->487|1689->494
