...
import views.html._
/**/
object reporteOrdenDePago extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template1[String,play.api.templates.HtmlFormat.Appendable] {
...
"""),_display_(Seq[Any](/*11.2*/if(url)/*11.9*/ {_display_(Seq[Any](format.raw/*11.11*/("""
	<div class="panel panel-default">
		<div class="panel-body">
	    	...
	    	Descargar archivo de reporte</a>
		</div>
	</div>
""")))})),format.raw/*19.2*/("""
...
"""),_display_(Seq[Any](/*21.2*/flash()/*21.9*/.clear())))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/contabilidad/facturas/reportes/reporteOrdenDePago.scala.html
                    HASH: ec8fd347ad80f56abec1dd070c105f0ff93fb4d0
                    MATRIX: 818->1|932->21|971->26|1009->56|1048->58|1167->142|1180->147|1215->160|1254->169|1293->174|1333->206|1372->208|1490->291|1503->296|1540->311|1579->320|1619->325|1634->332|1674->334|1841->465|1861->476|1948->541|2043->605|2083->610|2098->617
                    LINES: 26->1|29->1|31->3|31->3|31->3|32->4|32->4|32->4|33->5|35->7|35->7|35->7|36->8|36->8|36->8|37->9|39->11|39->11|39->11|43->15|43->15|43->15|47->19|49->21|49->21
                    -- GENERATED --
                */
