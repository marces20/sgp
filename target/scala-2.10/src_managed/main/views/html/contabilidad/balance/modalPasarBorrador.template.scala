...
"""),_display_(Seq[Any](/*5.2*/helper/*5.8*/.form(action = controllers.contabilidad.routes.BalanceController.pasarBorradorMasivo(), 'id -> "formPasarBorradorBalance")/*5.130*/ {_display_(Seq[Any](format.raw/*5.132*/("""	
...
"""),_display_(Seq[Any](/*14.2*/flash()/*14.9*/.clear())))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/contabilidad/balance/modalPasarBorrador.scala.html
                    HASH: f3d592f87210bffab680b4b208cc84a1b097add3
                    MATRIX: 813->1|942->47|974->71|1048->28|1076->115|1115->120|1128->126|1259->248|1299->250|1339->256|1351->261|1397->286|1618->476|1655->478|1670->485
