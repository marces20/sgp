...
"""),_display_(Seq[Any](/*5.2*/helper/*5.8*/.form(action = controllers.contabilidad.routes.PagosAccionesController.pasarBorradorMasivo(), 'id -> "formPasarBorradorPago")/*5.133*/ {_display_(Seq[Any](format.raw/*5.135*/("""	
...
"""),_display_(Seq[Any](/*14.2*/flash()/*14.9*/.clear())))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/contabilidad/pagos/acciones/modalPasarBorrador.scala.html
                    HASH: d023413b790b1e06493fc03389e535b454c24b5b
                    MATRIX: 820->1|949->47|981->71|1055->28|1083->115|1122->120|1135->126|1269->251|1309->253|1349->259|1361->264|1407->289|1628->479|1665->481|1680->488
