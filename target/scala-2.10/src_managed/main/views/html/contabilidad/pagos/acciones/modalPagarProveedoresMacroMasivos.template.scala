...
import views.html._
/**/
object modalPagarProveedoresMacroMasivos extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template1[DynamicForm,play.api.templates.HtmlFormat.Appendable] {
...
"""),_display_(Seq[Any](/*5.2*/helper/*5.8*/.form(action = controllers.contabilidad.routes.PagosAccionesController.pagarProveedoresMacroMasivos(), 'id -> "formPagar")/*5.130*/ {_display_(Seq[Any](format.raw/*5.132*/("""
...
"""),_display_(Seq[Any](/*27.2*/flash()/*27.9*/.clear())))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/contabilidad/pagos/acciones/modalPagarProveedoresMacroMasivos.scala.html
                    HASH: 248fe1944621b6f7beacaab4a3324abde6387c2e
