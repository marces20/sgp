...
import views.html._
/**/
object modalInformeLote extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template1[String,play.api.templates.HtmlFormat.Appendable] {
...
"""),_display_(Seq[Any](/*12.2*/if(url)/*12.9*/ {_display_(Seq[Any](format.raw/*12.11*/("""
	<div class="panel panel-default">
		<div class="panel-body">
	    	<i class="glyphicon glyphicon-save"></i> <a href=""""),_display_(Seq[Any](/*15.58*/controllers/*15.69*/.contabilidad.routes.FacturasAccionesController.descargar322(url))),format.raw/*15.134*/("""">Descargar archivo</a>
		</div>
	</div>
""")))})),format.raw/*18.2*/("""
...
"""),_display_(Seq[Any](/*20.2*/flash()/*20.9*/.clear())))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/contabilidad/pagos/reportes/modalInformeLote.scala.html
                    HASH: e57beb453ed1c2e864461fb10569486db1ece611
                    MATRIX: 813->1|927->21|966->26|1004->56|1043->58|1162->142|1175->147|1210->160|1249->169|1288->174|1328->206|1367->208|1485->291|1498->296|1535->311|1574->320|1616->327|1631->334|1671->336|1830->459|1850->470|1938->535|2014->580|2054->585|2069->592
