...
import views.html._
/**/
object modalPagarCheques extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template1[DynamicForm,play.api.templates.HtmlFormat.Appendable] {
...
"""),_display_(Seq[Any](/*5.2*/helper/*5.8*/.form(action = controllers.contabilidad.routes.PagosAccionesController.pagarCheques(), 'id -> "formPagarCheque")/*5.120*/ {_display_(Seq[Any](format.raw/*5.122*/("""
...
"""),_display_(Seq[Any](/*27.2*/flash()/*27.9*/.clear())))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/contabilidad/pagos/acciones/modalPagarCheques.scala.html
                    HASH: f7957a98e3a4778c9b0d351e1f08ea0da2f630b4
                    MATRIX: 819->1|944->43|976->67|1050->24|1078->111|1116->115|1129->121|1250->233|1290->235|1329->240|1341->245|1387->270|1501->348|1550->388|1590->390|1632->400|1749->482|1879->589|1930->605|1961->627|1980->637|2028->647|2095->678|2109->683|2139->691|2182->703|2410->900|2447->902|2462->909
