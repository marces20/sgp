...
import views.html._
/**/
object modalReporteDatos extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template1[String,play.api.templates.HtmlFormat.Appendable] {
...
"""),_display_(Seq[Any](/*12.2*/if(url)/*12.9*/ {_display_(Seq[Any](format.raw/*12.11*/("""
	<div class="panel panel-default">
		<div class="panel-body">
	    	<i class="glyphicon glyphicon-save"></i> <a href=""""),_display_(Seq[Any](/*15.58*/controllers/*15.69*/.contabilidad.routes.FacturasAccionesController.descargar322(url))),format.raw/*15.134*/("""">Descargar archivo de datos</a>
		</div>
	</div>
""")))})),format.raw/*18.2*/("""
...
"""),_display_(Seq[Any](/*20.2*/flash()/*20.9*/.clear())))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/contabilidad/cuentaBancarias/modalReporteDatos.scala.html
                    HASH: 632c77eb4f186de5714785a1b4046f6340db286a
                    MATRIX: 815->1|929->21|968->26|1006->56|1045->58|1164->142|1177->147|1212->160|1251->169|1290->174|1330->206|1369->208|1487->291|1500->296|1537->311|1576->320|1618->327|1633->334|1673->336|1832->459|1852->470|1940->535|2025->589|2065->594|2080->601
