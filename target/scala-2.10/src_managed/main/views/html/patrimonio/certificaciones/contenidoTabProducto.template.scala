...
import views.html._
/**/
object contenidoTabProducto extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template2[Boolean,Form[CertificacionServicio],play.api.templates.HtmlFormat.Appendable] {
...
""")))}/*6.3*/else/*6.8*/{_display_(Seq[Any](format.raw/*6.9*/("""
	...
	$( function ()"""),format.raw/*8.16*/("""{"""),format.raw/*8.17*/("""
		$.get('"""),_display_(Seq[Any](/*9.11*/controllers/*9.22*/.patrimonio.routes.LineasCertificacionesController.index(certificacionForm.field("id").value.toLong, formularioCarga))),format.raw/*9.139*/("""', function(data)"""),format.raw/*9.156*/("""{"""),format.raw/*9.157*/("""
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/patrimonio/certificaciones/contenidoTabProducto.scala.html
                    HASH: 004852d48f6818848e54942724feff458920da1a
                    MATRIX: 845->1|1043->82|1071->108|1108->111|1208->203|1246->204|1339->281|1350->286|1387->287|1442->315|1470->316|1517->328|1536->339|1675->456|1720->473|1749->474|1831->529|1859->530|1890->534|1918->535|1966->552
