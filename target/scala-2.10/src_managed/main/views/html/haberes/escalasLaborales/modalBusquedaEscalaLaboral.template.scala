...
<form action=""""),_display_(Seq[Any](/*6.16*/controllers/*6.27*/.haberes.routes.EscalasLaboralesController.modalBuscar())),format.raw/*6.83*/("""" method="GET">
	<div class="row">
		<div class="col-sm-6">
...
""")))}/*25.3*/else/*25.8*/{_display_(Seq[Any](format.raw/*25.9*/("""
	...
	<tr data-id=""""),_display_(Seq[Any](/*37.16*/lc/*37.18*/.id)),format.raw/*37.21*/("""" class="modalSeleccionEscalaLaboral">
	...
	<div class="pagination pull-right">
	    """),_display_(Seq[Any](/*45.7*/views/*45.12*/.html.helpers.paginador(buscador, controllers.haberes.routes.EscalasLaboralesController.modalBuscar()))),format.raw/*45.114*/("""
	</div>	
""")))})),format.raw/*47.2*/("""
</div>
...
$( function()"""),format.raw/*51.14*/("""{"""),format.raw/*51.15*/("""
	...
	var url = """"),_display_(Seq[Any](/*54.14*/controllers/*54.25*/.haberes.routes.EscalasLaboralesController.get())),format.raw/*54.73*/(""""
	contenedor.find('.modalSeleccionEscalaLaboral').on('click', function()"""),format.raw/*55.72*/("""{"""),format.raw/*55.73*/("""
...
"""),format.raw/*70.1*/("""}"""),format.raw/*70.2*/(""");
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/haberes/escalasLaborales/modalBusquedaEscalaLaboral.scala.html
                    HASH: 1d36dccb0d577e7bca87f7fa96cc500b86b484d1
                    MATRIX: 883->1|1082->118|1114->142|1188->97|1217->186|1356->290|1375->301|1452->357|1608->478|1716->564|1943->756|1986->790|2026->792|2117->866|2129->871|2167->872|2220->889|2237->897|2291->929|2507->1110|2550->1137|2590->1139|2643->1156|2654->1158|2679->1161|2762->1209|2773->1211|2802->1218|2857->1242|2972->1322|2986->1327|3111->1429|3155->1442|3218->1477|3247->1478|3369->1564|3389->1575|3459->1623|3561->1697|3590->1698|3694->1774|3723->1775|3825->1850|3853->1851|3885->1856|3913->1857|3996->1912|4025->1913|4165->2025|4194->2026|4261->2066|4289->2067|4338->2089|4366->2090|4397->2094|4425->2095
