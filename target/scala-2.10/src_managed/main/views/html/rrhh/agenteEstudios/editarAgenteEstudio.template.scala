...
import views.html._
/**/
object editarAgenteEstudio extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template1[Form[AgenteEstudio],play.api.templates.HtmlFormat.Appendable] {
...
"""),_display_(Seq[Any](/*5.2*/helper/*5.8*/.form(action = controllers.rrhh.routes.AgentesEstudiosController.actualizar())/*5.86*/ {_display_(Seq[Any](format.raw/*5.88*/("""
...
""")))})))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/rrhh/agenteEstudios/editarAgenteEstudio.scala.html
                    HASH: e667d5975372f7e5402f7cf0e0e45a28c2d79487
