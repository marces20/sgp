...
import views.html._
/**/
object crearAgenteFamilia extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template1[Form[AgenteFamilia],play.api.templates.HtmlFormat.Appendable] {
...
"""),_display_(Seq[Any](/*5.2*/helper/*5.8*/.form(action = controllers.rrhh.routes.AgentesFamiliasController.guardar())/*5.83*/ {_display_(Seq[Any](format.raw/*5.85*/("""
...
""")))})))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/rrhh/agenteFamilias/crearAgenteFamilia.scala.html
                    HASH: 99634737559a30eaaa91503e16e581ba66d45cd5
