...
import views.html._
/**/
object indexLineaCredito extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template2[utils.pagination.Pagination[LineaCreditoPresupuestario],Boolean,play.api.templates.HtmlFormat.Appendable] {

    /**/
    def apply/*1.2*/(paginador:  utils.pagination.Pagination[LineaCreditoPresupuestario], editable: Boolean):play.api.templates.HtmlFormat.Appendable = {
        _display_ {
...
<table id="listaDeLineaCreditoPresupuestario" class="table table-striped table-bordered">
	...
	"""),_display_(Seq[Any](/*26.3*/for(linea <- paginador.getList) yield /*26.34*/ {_display_(Seq[Any](format.raw/*26.36*/("""
		"""),_display_(Seq[Any](/*27.4*/views/*27.9*/.html.presupuesto.lineaCreditoPresupuestario.lineaCredito(linea, editable))),format.raw/*27.83*/("""
	""")))})),format.raw/*28.3*/("""
	</tbody>
</table>

<div class="pagination pull-right">
    """),_display_(Seq[Any](/*33.6*/views/*33.11*/.html.helpers.paginador(paginador, controllers.presupuesto.routes.LineasCreditosPresupuestariosController.index()))),format.raw/*33.125*/("""
</div>
</div>
...
$( function()"""),format.raw/*38.14*/("""{"""),format.raw/*38.15*/("""
	...
	contenedor.on('click', '#nuevoCredito', function()"""),format.raw/*45.52*/("""{"""),format.raw/*45.53*/("""
	...
	contenedor.on('click', '.modificarCredito', function()"""),format.raw/*51.56*/("""{"""),format.raw/*51.57*/("""
	...
	contenedor.on('click', '.eliminarCredito', function()"""),format.raw/*58.55*/("""{"""),format.raw/*58.56*/("""
	...
	function mostrarModal(url)"""),format.raw/*71.28*/("""{"""),format.raw/*71.29*/("""
		modalCargaCreditos = $('<div></div>').dialog("""),format.raw/*72.48*/("""{"""),format.raw/*72.49*/("""
			resizable: false,
		...
		modalCargaCreditos.on('click', '.cancelar', function()"""),format.raw/*88.57*/("""{"""),format.raw/*88.58*/("""
			modalCargaCreditos.dialog('destroy');
			return false;
		"""),format.raw/*91.3*/("""}"""),format.raw/*91.4*/(""");
		
		modalCargaCreditos.on('submit', function(e)"""),format.raw/*93.46*/("""{"""),format.raw/*93.47*/("""
...
"""))}
    ...
    def render(paginador:utils.pagination.Pagination[LineaCreditoPresupuestario],editable:Boolean): play.api.templates.HtmlFormat.Appendable = apply(paginador,editable)
    
    def f:((utils.pagination.Pagination[LineaCreditoPresupuestario],Boolean) => play.api.templates.HtmlFormat.Appendable) = (paginador,editable) => apply(paginador,editable)
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/presupuesto/lineaCreditoPresupuestario/indexLineaCredito.scala.html
                    HASH: 4bce532bdbbe3971a9b6071c58e9e1a4652a769d
