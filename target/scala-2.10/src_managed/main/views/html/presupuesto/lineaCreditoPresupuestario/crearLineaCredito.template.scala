...
import views.html._
/**/
object crearLineaCredito extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template1[Form[LineaCreditoPresupuestario],play.api.templates.HtmlFormat.Appendable] {
...
"""),_display_(Seq[Any](/*5.2*/helper/*5.8*/.form(action = controllers.presupuesto.routes.LineasCreditosPresupuestariosController.guardar())/*5.104*/ {_display_(Seq[Any](format.raw/*5.106*/("""
...
""")))})))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/marce/hspwork/play/sgpgit/sgp/app/views/presupuesto/lineaCreditoPresupuestario/crearLineaCredito.scala.html
                    HASH: ab63628428cb36929f6ab88e29bfca5a4727aac8
